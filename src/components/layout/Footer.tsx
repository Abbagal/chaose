      ...
      >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
                {links.map((link) => (
                  <Link
                    ...
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLAnchorElement).style.color = "rgba(139,92,246,0.9)";
                    }}
                    onMouseLeave={(e) => {
        ...
        >
          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-4 lg:gap-8">
            <p className="terminal-line" style={{ fontSize: 9, color: "rgba(255,255,255,0.35)", letterSpacing: "0.1em" }}>
            ...
            <div style={{ display: "flex", gap: "1.5rem" }}>
              {["Privacy Policy", "Terms of Use", "Security"].map((item) => (
                <Link
                  ...
                  onMouseEnter={(e) => { (e.currentTarget as HTMLAnchorElement).style.color = "rgba(139,92,246,0.85)"; }}
          ...
          <div className="terminal-line" style={{ fontSize: 9, color: "rgba(255,255,255,0.3)", letterSpacing: "0.12em" }}>
