      ...
      >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 mb-20">
          ...
          >
            ...
            >
              ...
              <span
                style={{
                  display: "block",
                  background: "linear-gradient(135deg, #7DF9FF 0%, #00FFB3 100%)",
                  WebkitBackgroundClip: "text",
                  WebkitTextFillColor: "transparent",
                  backgroundClip: "text",
                  filter: "drop-shadow(0 0 25px rgba(125,249,255,0.35))",
                }}
              >
                Defence AI
              </span>
            ...
            <div className="flex flex-wrap gap-2 mt-8">
              {SYSTEMS.map((s, i) => (
                <motion.div
                  ...
                  onMouseEnter={e => {
                    (e.currentTarget as HTMLDivElement).style.background = "rgba(125,249,255,0.07)";
                    (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(125,249,255,0.25)";
                    (e.currentTarget as HTMLDivElement).style.color = "rgba(125,249,255,0.85)";
                  }}
                  onMouseLeave={e => {
                    (e.currentTarget as HTMLDivElement).style.background = "rgba(125,249,255,0.03)";
                    (e.currentTarget as HTMLDivElement).style.borderColor = "rgba(125,249,255,0.12)";
                    (e.currentTarget as HTMLDivElement).style.color = "rgba(125,249,255,0.5)";
                  }}
                >
                  {s}
                </motion.div>
          ...
          >
            ...
            <div
              style={{
                borderLeft: "2px solid rgba(125,249,255,0.3)",
                paddingLeft: "1.5rem",
                marginBottom: "2rem",
                position: "relative",
              }}
            >
              ...
              <div
                style={{
                  ...
                  width: 2,
                  background: "linear-gradient(to bottom, #7DF9FF, #00FFB3)",
                  boxShadow: "0 0 12px rgba(125,249,255,0.5)",
                }}
              />
              <p
                style={{
              ...
              <p
                ...
                style={{ color: "rgba(125,249,255,0.35)", fontSize: 9 }}
              >
              ...
              {[
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    padding: "16px 20px",
                    borderTop: "2px solid rgba(125,249,255,0.15)",
                    transition: "background 0.3s, border-color 0.3s",
                  }}
                  onMouseEnter={e => {
                    (e.currentTarget as HTMLDivElement).style.background = "rgba(14,20,30,0.95)";
                    (e.currentTarget as HTMLDivElement).style.borderTopColor = "rgba(125,249,255,0.4)";
                  }}
                  onMouseLeave={e => {
                    (e.currentTarget as HTMLDivElement).style.background = "rgba(8,12,20,0.9)";
                    (e.currentTarget as HTMLDivElement).style.borderTopColor = "rgba(125,249,255,0.15)";
                  }}
                >
                  <div
                    style={{
