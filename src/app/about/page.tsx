...
export default function AboutPage() {
  ...
  return (
    <div className="bg-[#05070A] min-h-screen pt-20">
      ...
      {/* Mission */}
      <section ref={missionRef} className="relative py-24 bg-[#05070A]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              ...
              <p className="text-white/40 text-base leading-relaxed font-grotesk">
            ...
            >
              {[
                ...
                <div key={i} className="flex items-center bg-[#05070A] px-6 py-4">
          ...
          <div className="grid md:grid-cols-2 gap-px bg-white/[0.06]">
            {RESEARCH_AREAS.map((item, i) => (
              <motion.div
                ...
                className="bg-[#05070A] p-8 group hover:bg-[#05070A] transition-colors"
              >
      ...
      {/* Principles */}
      <section ref={principlesRef} className="relative py-24 bg-[#05070A]">
        <div className="absolute inset-0 tactical-grid opacity-30" />
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
