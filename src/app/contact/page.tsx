                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        type="text"
                        required
                        className="w-full bg-transparent border-0 border-b border-white/15 text-white text-sm py-3 focus:outline-none focus:border-white/50 transition-colors font-grotesk placeholder:text-white/25"
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-transparent border-0 border-b border-white/15 text-white text-sm py-3 focus:outline-none focus:border-white/50 transition-colors font-grotesk appearance-none"
                    >
                      <option value="" className="bg-[#05070A]">Select inquiry type</option>
                      {INQUIRY_TYPES.map((t) => (
                        <option key={t} value={t} className="bg-[#05070A]">{t}</option>
                      ))}
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      rows={5}
                      className="w-full bg-transparent border-0 border-b border-white/15 text-white text-sm py-3 focus:outline-none focus:border-white/50 transition-colors font-grotesk resize-none placeholder:text-white/25"
              ...
              <div>
                ...
                <div className="space-y-4">
                  {SECURITY_FEATURES.map((feat, i) => {
                    ...
                    return (
                      <div key={i} className="flex items-start gap-4 p-4 border border-white/[0.06] bg-white/[0.03]">
